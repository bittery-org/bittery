...
const outputRoot = path.join(packageRoot, "generated/recovery-control");
...
const schemaId = "urn:bittery:client-runtime:recovery-control";
...
const { stdout } = await run(
	...
	[
		...
		"--bin",
		"generate-recovery-contract-schema",
	],
	{ cwd: packageRoot },
);
...
const typesText = await compile(schema, "RecoveryContract", {
...
ajv.addSchema({
	$id: requestId,
	$ref: `${schemaId}#/$defs/RecoveryControlRequest`,
});
ajv.addSchema({
	$id: responseId,
	$ref: `${schemaId}#/$defs/RecoveryControlResponse`,
});
...
const validatorText = `/* This file is generated. Do not edit. */\n${generateStandaloneValidator(
	ajv,
	{
		validateRecoveryControlRequest: requestId,
		validateRecoveryControlResponse: responseId,
	},
)}`;
const declarationsText = `/* This file is generated. Do not edit. */
import type { RecoveryControlRequest, RecoveryControlResponse } from "./contract";
export declare function validateRecoveryControlRequest(value: unknown): value is RecoveryControlRequest;
export declare function validateRecoveryControlResponse(value: unknown): value is RecoveryControlResponse;
`;
...
if (check) {
	...
	if (stale.length > 0) {
		throw new Error(
			`Generated recovery contract is stale: ${stale.join(", ")}`,
		);
	}
} else {
