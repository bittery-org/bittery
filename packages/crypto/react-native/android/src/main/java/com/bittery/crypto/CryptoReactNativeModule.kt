...
package com.bittery.crypto

import com.facebook.react.bridge.ReactApplicationContext
import com.facebook.react.module.annotations.ReactModule
import com.facebook.react.turbomodule.core.interfaces.CallInvokerHolder

@ReactModule(name = CryptoReactNativeModule.NAME)
class CryptoReactNativeModule(reactContext: ReactApplicationContext) :
  NativeCryptoReactNativeSpec(reactContext) {
  ...
  // bittery-crypto-react-native.cpp
  ...
  companion object {
    const val NAME = "CryptoReactNative"

    init {
      System.loadLibrary("bittery-crypto-react-native")
    }
  }
}