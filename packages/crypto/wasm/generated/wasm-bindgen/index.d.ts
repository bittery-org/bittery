...
export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_f32(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_f64(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_i16(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_i32(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_i64(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_i8(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_rust_buffer(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_u16(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_u32(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_u64(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_u8(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_cancel_void(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_f32(handle: bigint, f_status_: RustCallStatus): number;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_f64(handle: bigint, f_status_: RustCallStatus): number;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_i16(handle: bigint, f_status_: RustCallStatus): number;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_i32(handle: bigint, f_status_: RustCallStatus): number;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_i64(handle: bigint, f_status_: RustCallStatus): bigint;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_i8(handle: bigint, f_status_: RustCallStatus): number;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_rust_buffer(handle: bigint, f_status_: RustCallStatus): Uint8Array;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_u16(handle: bigint, f_status_: RustCallStatus): number;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_u32(handle: bigint, f_status_: RustCallStatus): number;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_u64(handle: bigint, f_status_: RustCallStatus): bigint;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_u8(handle: bigint, f_status_: RustCallStatus): number;

export function ubrn_ffi_bittery_crypto_api_rust_future_complete_void(handle: bigint, f_status_: RustCallStatus): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_f32(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_f64(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_i16(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_i32(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_i64(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_i8(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_rust_buffer(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_u16(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_u32(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_u64(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_u8(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_free_void(handle: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_f32(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_f64(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_i16(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_i32(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_i64(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_i8(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_rust_buffer(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_u16(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_u32(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_u64(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_u8(handle: bigint, callback: any, callback_data: bigint): void;

export function ubrn_ffi_bittery_crypto_api_rust_future_poll_void(handle: bigint, callback: any, callback_data: bigint): void;
...
export function ubrn_uniffi_bittery_crypto_api_checksum_func_perform_key_rotation(): number;
...
export function ubrn_uniffi_bittery_crypto_api_checksum_func_validate_rotation_data(): number;
...
export function ubrn_uniffi_bittery_crypto_api_fn_clone_keyhandle(handle: bigint, f_status_: RustCallStatus): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_clone_srpclient(handle: bigint, f_status_: RustCallStatus): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_clone_srpserver(handle: bigint, f_status_: RustCallStatus): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_constructor_srpclient_new(f_status_: RustCallStatus): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_constructor_srpserver_new(f_status_: RustCallStatus): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_free_keyhandle(handle: bigint, f_status_: RustCallStatus): void;

export function ubrn_uniffi_bittery_crypto_api_fn_free_srpclient(handle: bigint, f_status_: RustCallStatus): void;

export function ubrn_uniffi_bittery_crypto_api_fn_free_srpserver(handle: bigint, f_status_: RustCallStatus): void;

export function ubrn_uniffi_bittery_crypto_api_fn_func_build_passkey_attestation_object(rp_id: Uint8Array, credential_id_base64: Uint8Array, cose_public_key_base64: Uint8Array, sign_count: number): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_clone_key(key: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_decrypt(data: Uint8Array, key: bigint, context: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_decrypt_many(requests: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_decrypt_master_key(data: Uint8Array, recovery_key: Uint8Array, email: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_decrypt_rsa_wrapped_key(ciphertext: Uint8Array, encrypted_private_key: Uint8Array, private_key_wrapping_key: bigint, private_key_context: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_derive_client_session(client_ephemeral_secret: Uint8Array, challenge: Uint8Array, password: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_derive_keys(account_password: Uint8Array, secret_key: Uint8Array, email: Uint8Array, profile: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_derive_keys_from_master_key(master_key: bigint, email: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_derive_master_key(account_password: Uint8Array, secret_key: Uint8Array, email: Uint8Array, profile: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_derive_srp_password(auth_key: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_destroy_key(key: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_encrypt(plaintext: Uint8Array, key: bigint, context: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_encrypt_master_key(master_key: bigint, recovery_key: Uint8Array, email: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_encrypt_vault_key_for_member(vault_key: bigint, member_public_key_pem: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_encrypt_vault_key_with_muk(vault_key: bigint, master_unlock_key: bigint, vault_id: Uint8Array, user_id: Uint8Array, key_version: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_export_key(key: bigint): bigint;
...
export function ubrn_uniffi_bittery_crypto_api_fn_func_generate_srp_registration(password: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_generate_totp(secret: Uint8Array, algorithm: Uint8Array, digits: number, period: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_generate_totp_at(secret: Uint8Array, algorithm: Uint8Array, digits: number, period: bigint, timestamp: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_generate_uuid(): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_import_key(key: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_initialize(): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_perform_key_rotation(old_vault_key: bigint, members: Uint8Array, items: Uint8Array, vault_id: Uint8Array, key_version: bigint, current_user_id: Uint8Array, master_unlock_key: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_re_encrypt_item(item: Uint8Array, old_vault_key: bigint, new_vault_key: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_rsa_decrypt(ciphertext: Uint8Array, private_key_pem: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_rsa_encrypt(plaintext: Uint8Array, public_key_pem: Uint8Array): bigint;
...
export function ubrn_uniffi_bittery_crypto_api_fn_func_validate_rotation_data(members: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_validate_secret_key(secret_key: Uint8Array): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_func_verify_server_session(client_public_ephemeral: Uint8Array, session: Uint8Array, server_session_proof: Uint8Array): bigint;
...
export function ubrn_uniffi_bittery_crypto_api_fn_method_srpclient_generate_salt(ptr: bigint): bigint;

export function ubrn_uniffi_bittery_crypto_api_fn_method_srpserver_generate_ephemeral(ptr: bigint, verifier: Uint8Array): bigint;
...
export interface InitOutput {
    ...
    readonly uniffi_bittery_crypto_api_fn_func_generate_totp: (a: number, b: number, c: number, d: bigint) => bigint;
    ...
    readonly ffi_bittery_crypto_api_rust_future_poll_i8: (a: bigint, b: number, c: bigint) => void;
    ...
    readonly ffi_bittery_crypto_api_rust_future_poll_u32: (a: bigint, b: number, c: bigint) => void;
    ...
    readonly uniffi_bittery_crypto_api_checksum_func_perform_key_rotation: () => number;
    ...
    readonly uniffi_bittery_crypto_api_fn_func_decrypt_master_key: (a: number, b: number, c: number) => bigint;
    readonly uniffi_bittery_crypto_api_fn_func_decrypt_rsa_wrapped_key: (a: number, b: number, c: bigint, d: number) => bigint;
    ...
    readonly uniffi_bittery_crypto_api_fn_method_srpclient_generate_salt: (a: bigint) => bigint;
    readonly uniffi_bittery_crypto_api_fn_clone_srpserver: (a: bigint, b: number) => bigint;
    ...
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_i32: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_i64: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_i8: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_rust_buffer: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_u16: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_u32: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_u64: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_u8: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_cancel_void: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_f32: (a: bigint, b: number) => number;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_f64: (a: bigint, b: number) => number;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_i16: (a: bigint, b: number) => number;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_i32: (a: bigint, b: number) => number;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_i64: (a: bigint, b: number) => bigint;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_i8: (a: bigint, b: number) => number;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_rust_buffer: (a: bigint, b: number) => [number, number];
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_u16: (a: bigint, b: number) => number;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_u32: (a: bigint, b: number) => number;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_u64: (a: bigint, b: number) => bigint;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_u8: (a: bigint, b: number) => number;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_complete_void: (a: bigint, b: number) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_f32: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_f64: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_i16: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_i32: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_i64: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_i8: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_rust_buffer: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_u16: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_u32: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_u64: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_u8: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_free_void: (a: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_f32: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_f64: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_i16: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_i32: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_i64: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_i8: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_rust_buffer: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_u16: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_u32: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_u64: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_u8: (a: bigint, b: any, c: bigint) => void;
    readonly ubrn_ffi_bittery_crypto_api_rust_future_poll_void: (a: bigint, b: any, c: bigint) => void;
    ...
    readonly ubrn_uniffi_bittery_crypto_api_checksum_func_perform_key_rotation: () => number;
    ...
    readonly ubrn_uniffi_bittery_crypto_api_checksum_func_validate_rotation_data: () => number;
    ...
    readonly ubrn_uniffi_bittery_crypto_api_fn_clone_keyhandle: (a: bigint, b: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_clone_srpclient: (a: bigint, b: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_clone_srpserver: (a: bigint, b: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_constructor_srpclient_new: (a: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_constructor_srpserver_new: (a: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_free_keyhandle: (a: bigint, b: number) => void;
    readonly ubrn_uniffi_bittery_crypto_api_fn_free_srpclient: (a: bigint, b: number) => void;
    readonly ubrn_uniffi_bittery_crypto_api_fn_free_srpserver: (a: bigint, b: number) => void;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_build_passkey_attestation_object: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_clone_key: (a: bigint) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_decrypt: (a: number, b: number, c: bigint, d: number, e: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_decrypt_many: (a: number, b: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_decrypt_master_key: (a: number, b: number, c: number, d: number, e: number, f: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_decrypt_rsa_wrapped_key: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_derive_client_session: (a: number, b: number, c: number, d: number, e: number, f: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_derive_keys: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_derive_keys_from_master_key: (a: bigint, b: number, c: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_derive_master_key: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_derive_srp_password: (a: bigint) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_destroy_key: (a: bigint) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_encrypt: (a: number, b: number, c: bigint, d: number, e: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_encrypt_master_key: (a: bigint, b: number, c: number, d: number, e: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_encrypt_vault_key_for_member: (a: bigint, b: number, c: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_encrypt_vault_key_with_muk: (a: bigint, b: bigint, c: number, d: number, e: number, f: number, g: bigint) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_export_key: (a: bigint) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_generate_srp_registration: (a: number, b: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_generate_totp: (a: number, b: number, c: number, d: number, e: number, f: bigint) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_generate_totp_at: (a: number, b: number, c: number, d: number, e: number, f: bigint, g: bigint) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_import_key: (a: number, b: number) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_perform_key_rotation: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number, h: bigint, i: number, j: number, k: bigint) => bigint;
    readonly ubrn_uniffi_bittery_crypto_api_fn_func_re_encrypt_item: (a: number, b: number, c: bigint, d: bigint) => bigint;
    ...
    readonly ubrn_uniffi_bittery_crypto_api_fn_method_srpserver_generate_ephemeral: (a: bigint, b: number, c: number) => bigint;
    ...
    readonly ffi_bittery_crypto_api_rustbuffer_alloc: (a: number, b: bigint, c: number) => void;
    readonly ffi_bittery_crypto_api_rustbuffer_free: (a: number, b: number) => void;
    readonly ffi_bittery_crypto_api_rustbuffer_from_bytes: (a: number, b: number, c: number) => void;
    readonly ffi_bittery_crypto_api_rustbuffer_reserve: (a: number, b: number, c: bigint, d: number) => void;
