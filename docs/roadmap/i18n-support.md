...
- Update apps/web/src/routes/\_\_root.tsx to use runtime locale for <html lang>.
...
3. Locale preference persists across sessions.
4. Core UX text (auth/nav/settings) is translated in v1.
5. Date/number/currency formatting honors active locale.
6. Shared translation source is in packages/i18n and ready for other apps.
