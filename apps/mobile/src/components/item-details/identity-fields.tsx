...
export function IdentityFields({ item, onCopy }: ItemDetailProps) {
  ...
  return (
    <>
      ...
      <FieldRow label="Email" value={item.email} onCopy={onCopy} options={{ icon: Mail }} />
      <FieldRow label="Date of Birth" value={item.dateOfBirth} onCopy={onCopy} />
      <FieldRow
        label="SSN"
        value={item.ssn}
        onCopy={onCopy}
      ...
      />
      <FieldRow label="Passport Number" value={item.passportNumber} onCopy={onCopy} />
      <FieldRow label="Driver's License" value={item.driversLicense} onCopy={onCopy} />
