...
android {
	...
	sourceSets.getByName("main") {
		...
		//
		// packages/crypto/android holds nothing but this generated output, so the whole
		// java root can be a source root — no risk of a neighbouring file joining the
		// classpath.
		java.srcDir("../../../../../../packages/crypto/android/generated/java")
		...
		jniLibs.srcDirs("../../../../../../packages/crypto/android/generated/jniLibs")
	}
