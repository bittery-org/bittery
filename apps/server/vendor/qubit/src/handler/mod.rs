...
pub trait QubitHandler<Ctx, MSig>: 'static + Send + Sync + Clone {
    ...
    fn call(&self, ctx: Self::Ctx, params: Params) -> Result<Self::Return, ErrorObjectOwned>;
}
...
macro_rules! impl_handlers {
    (impl [$($ctx:ident, $($params:ident,)*)?]) => {
            ...
            $($($params: 'static + TS + Send + for<'a> Deserialize<'a>),*)?
        {
            ...
            ) -> Result<Self::Return, ErrorObjectOwned> {
                #[allow(non_snake_case)]
                let ($($($params,)*)?) = impl_handlers!(parse_impl params -> [$($($params,)*)?])?;
            ...
            .register_async_method(
                ...
                move |params, ctx, extensions| {
                    ...
                    async move {
                        ...
                        let result = match handler.call(ctx, params) {
                            Ok(result) => result,
                            Err(error) => return ResponsePayload::error(error),
                        };
            ...
            .register_async_method(
                ...
                move |params, ctx, extensions| {
                    ...
                    async move {
                        ...
                        let result = match f.call(ctx, params) {
            ...
            .register_subscription(
                ...
                move |params, pending, ctx, extensions| {
                    ...
                    async move {
                        ...
                        let stream = match f.call(ctx, params) {
                            Ok(stream) => stream,
                            Err(error) => {
