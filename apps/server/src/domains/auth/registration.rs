...
use crate::{
    ...
    db::events::{generate_resource_id, hash_token},
    db::{
    ...
    domains::{
        ...
        billing::{self, entitlements::team_management_enabled},
        sessions::service::{format_rfc3339, now_utc, RequestMetadata},
        teams::{assert_invitation_pending_vault_keys_are_authorized, parse_pending_vault_keys},
...
use billing::sync_team_seats_best_effort;
