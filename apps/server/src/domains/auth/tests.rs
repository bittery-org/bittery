                    ...
                    .api_json(
                        ...
                        Some(json!({
                            ...
                            "encryptedVaultKeys": [{
                                ...
                                "encryptedVaultKey": "k".repeat(crate::domains::vaults::key::ENCRYPTED_VAULT_KEY_MAX_BYTES + 1)
                            }],
                            "kdfParams": floor_kdf_params_json(),
                        })),
                        unauthenticated_json_headers(),
...
async fn auth_account_mutations_update_credentials_and_revoke_sessions() {
    with_api_test_app(
        ...
        |app| async move {
            ...
            let oversized_key =
                "k".repeat(crate::domains::vaults::key::ENCRYPTED_VAULT_KEY_MAX_BYTES + 1);
...
fn every_auth_vault_key_input_rejects_oversized_values() {
    let oversized = "k".repeat(crate::domains::vaults::key::ENCRYPTED_VAULT_KEY_MAX_BYTES + 1);
        ...
        with_rate_limit_test_app(
            ...
            |app| async move {
                ...
                assert_handler_error(
                    &tripped.body,
                    RATE_LIMITED_CODE,
                    crate::shared::rate_limit::RATE_LIMITED_MESSAGE,
                );
