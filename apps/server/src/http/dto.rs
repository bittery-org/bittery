...
use crate::{domains, integrations::storage::PresignedUploadResult, shapes::success_shape};
...
success_shape!(shape_from { domains::shares::SuccessResponse => SuccessResponse });
success_shape!(shape_from { domains::teams::SuccessResponse => SuccessResponse });
success_shape!(shape_from { domains::vaults::SuccessResponse => SuccessResponse });
