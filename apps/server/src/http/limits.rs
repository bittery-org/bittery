...
/// [`ENCRYPTED_VAULT_KEY_MAX_BYTES`](crate::domains::vaults::key::ENCRYPTED_VAULT_KEY_MAX_BYTES).
...
/// [`MAX_LIMIT`](crate::domains::teams::audit::MAX_LIMIT).
pub const MAX_AUDIT_EVENTS: u16 = crate::domains::teams::audit::MAX_LIMIT as u16;

/// Audit page size used when a request omits `limit`, matching
/// [`DEFAULT_LIMIT`](crate::domains::teams::audit::DEFAULT_LIMIT).
pub const DEFAULT_AUDIT_EVENTS: u16 = crate::domains::teams::audit::DEFAULT_LIMIT as u16;
