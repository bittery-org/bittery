...
const OPERATION_SECURITY: &[(&str, OperationSecurity)] = &[
    ...
    ("checkEmail", OperationSecurity::Public),
    ("startLogin", OperationSecurity::Public),
    ("finishLogin", OperationSecurity::Public),
    ("listCurrentUserVaultKeys", OperationSecurity::Bearer),
    ("recoveryData", OperationSecurity::Public),
    ("resetPassword", OperationSecurity::Public),
    ("requestRecoveryVerification", OperationSecurity::Public),
    ("verifyRecovery", OperationSecurity::Public),
    ("getRegistrationStatus", OperationSecurity::Public),
    ("requestSignupVerification", OperationSecurity::Public),
    ("verifySignupVerification", OperationSecurity::Public),
    ...
    ("listSessions", OperationSecurity::Bearer),
    ("refreshSession", OperationSecurity::Bearer),
    ("revokeSession", OperationSecurity::Bearer),
    ("renameSession", OperationSecurity::Bearer),
    ...
    ("deleteAccount", OperationSecurity::Bearer),
    ("updateEmail", OperationSecurity::Bearer),
    ("changePassword", OperationSecurity::Bearer),
    ("storeRecoveryKey", OperationSecurity::Bearer),
    ("regenerateSecretKey", OperationSecurity::Bearer),
    ...
    ("grantVaultImageStaging", OperationSecurity::Bearer),
    ("getVaultImageStagingStatus", OperationSecurity::Bearer),
    ("confirmVaultImageStaging", OperationSecurity::Bearer),
    ...
    ("getItemAuthority", OperationSecurity::Bearer),
