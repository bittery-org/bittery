...
async fn baseline_sqlx_from_legacy_drizzle(
	...
	let sqlx_table_exists: bool = query_scalar(
	...
	let drizzle_table_exists: bool = query_scalar(
	...
	info!(legacy_migration_count, "baselining sqlx migrations from legacy drizzle history");
