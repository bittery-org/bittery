...
export function AccountSettingsDialog({
	...
	useEffect(() => {
		if (open && webAppUrlQuery.data !== undefined) {
			setWebAppUrl(webAppUrlQuery.data || "");
			setIsDirty(false);
		}
	}, [open, webAppUrlQuery.data]);

	// Mutation to save web app URL
	...
	const isLoading = webAppUrlQuery.isLoading || serverUrlQuery.isLoading;
