...
export function LoginPage() {
  ...
  useState(() => {
    tauriStorage.isBiometricAvailable().then(setBiometricAvailable);
  });
    ...
    <div className="flex h-full items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md p-6">
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-bold">Bittery</h1>
          <p className="text-sm text-gray-600">Password Manager</p>
        </div>
