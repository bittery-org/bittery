...
function RouteComponent() {
  ...
  const handleCreateItem = async (
    ...
    try {
      ...
      await queryClient.prefetchQuery(trpc.vault.getItem.queryOptions({ itemId: createdItem.itemId }));
      // Invalidate queries to refresh the list
      await queryClient.invalidateQueries(trpc.vault.listItems.queryOptions({ vaultId }));
