...
use crate::{
    ...
    domains::{
        ...
        sessions::service::{RenameDeviceInput, SessionIdInput},
    },
...
use crate::http::{
    ...
    error::ApiError,
    extractors::{ApiJson, ApiMergePatch, AuthenticatedRequest, PublicRequest},
...
session_shape!(shape_from {
    crate::domains::sessions::service::DeviceSessionResponse => SessionResponse
});
...
refresh_session_shape!(shape_from {
    crate::domains::sessions::service::RefreshSessionResponse => RefreshSessionResponse
});
...
#[utoipa::path(post, path = "/auth/email-checks", operation_id = "checkEmail", request_body = EmailCheckRequest, responses((status = 200, body = EmailCheckResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json")))]
...
#[utoipa::path(post, path = "/auth/signup-verifications/verify", operation_id = "verifySignupVerification", request_body = VerifySignupVerificationRequest, responses((status = 200, body = VerifySignupVerificationResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 404, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 429, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json", headers(("Retry-After" = String, description = "Seconds before retrying")))))]
...
#[utoipa::path(post, path = "/auth/signups", operation_id = "signup", request_body = SignupRequest, responses((status = 201, body = SignupResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 401, description = "Signup verification token is missing or invalid", body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 403, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 404, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 409, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 429, description = "Signup rate limit exceeded", body = crate::http::dto::ProblemDetails, content_type = "application/problem+json", headers(("Retry-After" = String, description = "Seconds before retrying")))))]
async fn signup(
    State(state): State<AppState>,
    request: PublicRequest,
...
#[utoipa::path(post, path = "/auth/login-attempts", operation_id = "startLogin", request_body = StartLoginRequest, responses((status = 201, body = LoginAttemptResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 404, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 429, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json", headers(("Retry-After" = String, description = "Seconds before retrying")))))]
...
#[utoipa::path(post, path = "/auth/login-attempts/{attemptId}/finish", operation_id = "finishLogin", params(("attemptId" = String, Path)), request_body = FinishLoginRequest, responses((status = 200, body = FinishLoginResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 401, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 429, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json", headers(("Retry-After" = String, description = "Seconds before retrying")))))]
...
#[utoipa::path(get, path = "/users/me/vault-keys", operation_id = "listCurrentUserVaultKeys", tag = "auth", params(PageRequest), responses((status = 200, body = CursorPage<AuthVaultKeyResponse>), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 401, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 413, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 500, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json")))]
...
#[utoipa::path(post, path = "/auth/recovery-verifications", operation_id = "requestRecoveryVerification", request_body = RecoveryVerificationRequest, responses((status = 202, body = SuccessResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 404, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 429, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json", headers(("Retry-After" = String, description = "Seconds before retrying")))))]
...
#[utoipa::path(post, path = "/auth/recovery-verifications/verify", operation_id = "verifyRecovery", request_body = VerifyRecoveryRequest, responses((status = 200, body = VerifyRecoveryResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 404, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 429, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json", headers(("Retry-After" = String, description = "Seconds before retrying")))))]
...
#[utoipa::path(post, path = "/auth/recovery-sessions/data", operation_id = "recoveryData", request_body = RecoverySessionRequest, responses((status = 200, body = RecoveryDataResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 401, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 404, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json")))]
...
#[utoipa::path(post, path = "/auth/recovery-sessions/reset-password", operation_id = "resetPassword", request_body = ResetPasswordRequest, responses((status = 200, body = ResetPasswordResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 401, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 409, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json")))]
...
#[utoipa::path(get, path = "/users/me", operation_id = "me", responses((status = 200, body = MeResponse), (status = 401, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 500, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json")))]
async fn me(
    State(state): State<AppState>,
    request: AuthenticatedRequest,
...
#[utoipa::path(get, path = "/sessions", operation_id = "listSessions", params(PageRequest), responses((status = 200, body = CursorPage<SessionResponse>), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 401, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 500, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json")))]
...
#[utoipa::path(put, path = "/users/me/recovery-key", operation_id = "storeRecoveryKey", request_body = RecoveryKeyRequest, responses((status = 200, body = SuccessResponse), (status = 400, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 401, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json")))]
...
#[utoipa::path(post, path = "/sessions/current/refresh", operation_id = "refreshSession", responses((status = 200, body = RefreshSessionResponse), (status = 401, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json"), (status = 500, body = crate::http::dto::ProblemDetails, content_type = "application/problem+json")))]
...
fn initial_vault_key_page(
    ...
    map_vault_key_page(
        ...
        &PageRequest {
            cursor: None,
            limit: crate::http::dto::DEFAULT_PAGE_SIZE,
        },
        user_id,
        jwt_secret,
    )
